...
<div class="flex flex-col gap-2 p-2">
              ...
              <div class="flex flex-col gap-0.5">
                ...
                <label class="flex items-center gap-2 mt-1 cursor-pointer select-none">
                  <input type="checkbox" v-model="isInclusiveTax" :disabled="quotationDocStatus !== 0 || quotationSaved" class="h-4 w-4 rounded border-slate-600 accent-blue-500 cursor-pointer disabled:cursor-not-allowed" />
