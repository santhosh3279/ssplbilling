                ...
                <td class="border border-slate-700 px-2" rowspan="10">
                  <div class="flex flex-col gap-2 h-full py-2">
                    ...
                    <div class="flex gap-2">
                      <div class="flex-1">
                        <button @click="billSaved && billDocStatus === 0 ? enterEditMode() : saveBill()" 
                          ref="saveButton"
                          class="w-full rounded py-2.5 text-center text-xl font-semibold text-white transition shadow uppercase"
                          :class="billSaved && billDocStatus === 0 ? 'bg-amber-600 hover:bg-amber-700' : 'bg-[#285A48] hover:bg-[#1e4538]'"
                        >
                          {{ billSaved && billDocStatus === 0 ? 'Modify Bill' : (savedInvoiceName ? 'Update Bill' : 'Save (Ctrl+S)') }}
                        </button>
                      </div>
