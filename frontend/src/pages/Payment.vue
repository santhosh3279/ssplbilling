                  ...
                  <div v-if="outstandingBalance !== null" class="flex flex-col items-end">
                    <div class="flex items-center gap-3">
                      ...
                      <button 
                        v-if="form.party"
                        @click="fetchInvoices"
                        class="flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--color-highlight)]/10 text-xl font-bold text-[var(--color-highlight)] transition-all hover:bg-[var(--color-highlight)] hover:text-[var(--color-text-on-highlight)]"
