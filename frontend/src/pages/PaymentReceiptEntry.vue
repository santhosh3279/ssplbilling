  ...
  <div class="flex h-screen flex-col bg-gray-950 overflow-hidden">
    ...
    <div class="flex-1 flex overflow-hidden">
      ...
      <div class="flex-1 flex flex-col border-r border-gray-800 overflow-hidden bg-gray-900">
        <!-- TOP Section (85%) -->
        <div class="h-[85%] flex flex-col overflow-hidden">
          <!-- Panel header -->
          ...
          <!-- Top section footer: allocation summary -->
          <div v-if="outstandings.length" class="shrink-0 border-t border-gray-800 px-6 py-3 bg-gray-900 flex items-center justify-between">
            <div class="flex items-center gap-6">
              ...
              <div v-if="amount > 0" class="text-xs font-black uppercase tracking-widest flex items-center gap-2">
        ...
        <!-- BOTTOM Section (15%) - Ledger Summary -->
        <div class="h-[15%] border-t border-gray-800 bg-gray-950 px-6 py-4 flex flex-col justify-center">
          <div v-if="party" class="grid grid-cols-2 gap-8 items-center h-full">
            <!-- Party Balances -->
            <div class="flex items-center gap-6">
              <div class="space-y-1">
                <p class="text-[9px] font-black uppercase tracking-widest text-gray-500">{{ activePartyType }} Balance</p>
                <p class="font-mono text-xs font-black text-gray-300">{{ formatBalance(ledgerBalance) }}</p>
              </div>
              ...
              <div class="space-y-1">
                <p class="text-[9px] font-black uppercase tracking-widest text-blue-400">Projected</p>
                <p class="font-mono text-xs font-black text-blue-300">{{ formatBalance(newBalance) }}</p>
              </div>
            </div>
          ...
          <div v-else class="flex items-center justify-center h-full">
             <p class="text-[10px] font-black text-gray-600 uppercase tracking-widest italic">Party not selected</p>
          </div>
        </div>
      </div>
...
function formatBalance(val) {
  const absVal = Math.abs(val || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })
