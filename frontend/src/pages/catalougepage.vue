              ...
              <div class="shrink-0 space-y-2 pt-3 border-t border-slate-800/60">
                ...
                <div v-if="websiteUser" class="flex items-center justify-center gap-2 text-white">
                  <template v-if="item.order_rate != null">
                    <button v-if="minimumOrderQuantity(item) > 1" type="button" :aria-label="`Decrease ${item.itemname} by ${minimumOrderQuantity(item)}`" class="rounded-lg border px-2 py-1 font-bold transition-colors border-rose-300/40 bg-rose-400/20 text-rose-100 shadow-lg shadow-rose-950/20 backdrop-blur-md hover:bg-rose-400/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-300" @click="adjustByMinimum(item, -1)">−{{ minimumOrderQuantity(item) }}</button>
                    <button type="button" :aria-label="`Decrease ${item.itemname}`" class="rounded-lg border px-3 py-1 font-bold transition-colors border-rose-300/40 bg-rose-400/20 text-rose-100 shadow-lg shadow-rose-950/20 backdrop-blur-md hover:bg-rose-400/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-300" @click="adjustQuantity(item, -1)">−</button>
                    <span class="w-8 text-center font-bold">{{ getQuantity(pageaddress, item.itemcode) }}</span>
                    <button type="button" :aria-label="`Increase ${item.itemname}`" class="rounded-lg border px-3 py-1 font-bold transition-colors border-emerald-300/40 bg-emerald-400/20 text-emerald-100 shadow-lg shadow-emerald-950/20 backdrop-blur-md hover:bg-emerald-400/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-300" @click="adjustQuantity(item, 1)">+</button>
                    <button v-if="minimumOrderQuantity(item) > 1" type="button" :aria-label="`Increase ${item.itemname} by ${minimumOrderQuantity(item)}`" class="rounded-lg border px-2 py-1 font-bold transition-colors border-emerald-300/40 bg-emerald-400/20 text-emerald-100 shadow-lg shadow-emerald-950/20 backdrop-blur-md hover:bg-emerald-400/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-300" @click="adjustByMinimum(item, 1)">+{{ minimumOrderQuantity(item) }}</button>
                  </template>
            ...
            >
              ...
              <div class="flex-1 flex flex-col justify-between" :class="cardPaddingClass">
                ...
                <div v-if="websiteUser" class="flex items-center justify-center gap-2 border-t border-[var(--color-border)]/40 pt-3">
                  <template v-if="item.order_rate != null">
                    <button v-if="minimumOrderQuantity(item) > 1" type="button" :aria-label="`Decrease ${item.itemname} by ${minimumOrderQuantity(item)}`" class="rounded-lg border px-2 py-1 font-bold transition-colors border-rose-500/40 bg-rose-500/15 text-rose-700 shadow-lg shadow-rose-900/10 backdrop-blur-md hover:bg-rose-500/25 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500 dark:text-rose-200" @click="adjustByMinimum(item, -1)">−{{ minimumOrderQuantity(item) }}</button>
                    <button type="button" :aria-label="`Decrease ${item.itemname}`" class="rounded-lg border px-3 py-1 font-bold transition-colors border-rose-500/40 bg-rose-500/15 text-rose-700 shadow-lg shadow-rose-900/10 backdrop-blur-md hover:bg-rose-500/25 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500 dark:text-rose-200" @click="adjustQuantity(item, -1)">−</button>
                    <span class="w-8 text-center font-bold">{{ getQuantity(pageaddress, item.itemcode) }}</span>
                    <button type="button" :aria-label="`Increase ${item.itemname}`" class="rounded-lg border px-3 py-1 font-bold transition-colors border-emerald-500/40 bg-emerald-500/15 text-emerald-700 shadow-lg shadow-emerald-900/10 backdrop-blur-md hover:bg-emerald-500/25 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 dark:text-emerald-200" @click="adjustQuantity(item, 1)">+</button>
                    <button v-if="minimumOrderQuantity(item) > 1" type="button" :aria-label="`Increase ${item.itemname} by ${minimumOrderQuantity(item)}`" class="rounded-lg border px-2 py-1 font-bold transition-colors border-emerald-500/40 bg-emerald-500/15 text-emerald-700 shadow-lg shadow-emerald-900/10 backdrop-blur-md hover:bg-emerald-500/25 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 dark:text-emerald-200" @click="adjustByMinimum(item, 1)">+{{ minimumOrderQuantity(item) }}</button>
                  </template>
...
function goBackToCatalogue() {
  router.push({ name: 'CatalogueViewer' })
}
