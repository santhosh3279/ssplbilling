              ...
              <tr>
                ...
                <td class="border border-slate-700 px-2" rowspan="11">
                  <div class="flex flex-col gap-2 h-full py-2">
                    ...
                    <button v-if="billSaved" @click="openPrintModal(savedInvoiceName)" class="w-full rounded border border-slate-600 bg-slate-800 py-1.5 text-center text-xs font-semibold text-slate-300 hover:bg-slate-700 transition">🖨 Print</button>
...
// Watch for changes in grid item barcodes to show quick search
