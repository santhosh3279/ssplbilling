<template>
  <div class="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] font-sans flex flex-col">
    ...
    <!-- Nav Bar -->
    <nav class="fixed top-0 left-0 right-0 z-50 flex h-16 items-center justify-between border-b border-[var(--color-border)] bg-[var(--color-bg)]/90 px-6 backdrop-blur-xl">
      <div class="flex items-center gap-6">
        ...
        <span v-if="billNo" class="rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-1 text-xs font-bold text-[var(--color-info)]">
          {{ billNo }}
        </span>
      </div>
    ...
    <div class="flex flex-1 gap-4 p-4 pt-20" style="height: calc(100vh - 4rem);">
      ...
      <div class="flex flex-col gap-3 w-64 flex-shrink-0">
        ...
        <div class="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)]/60 p-4">
