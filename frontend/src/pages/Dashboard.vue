...
const allTiles = [
  ...
  { id: 'batch-reports',      bucket: 'report',   name: 'Batch Reports',         desc: 'Batch download reports as ZIP',            icon: '📦', shortcut: ''    },
]
...
async function syncBillingSettings(targetUser, force) {
  try {
    ...
    //                        Ledger templates are stored with an empty document_type)
