...
const allTiles = [
  ...
  { id: 'paymentv2',          bucket: 'accounts', name: 'Payment V2',            desc: 'New payment interface',                    icon: '💰', shortcut: ''  },
