      ...
      <div class="border-b border-slate-700 px-5 py-4 flex items-center gap-8 bg-slate-800">
        ...
        <div class="flex-1 relative">
          <input
            ref="searchInput"
            v-model="query"
            class="w-full rounded border border-slate-600 bg-slate-900 p-[2px] text-4xl text-slate-200 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
