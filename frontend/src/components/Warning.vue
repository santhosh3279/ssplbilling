<template>
  ...
  >
    <div class="w-[450px] rounded-2xl border-[5px] border-[color-mix(in_srgb,var(--color-danger)_70%,black_30%)] bg-[color-mix(in_srgb,var(--color-bg)_92%,var(--color-danger)_8%)] p-8 shadow-2xl">
