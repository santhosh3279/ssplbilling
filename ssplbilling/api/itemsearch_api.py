...
def get_single_item_detailed(item_code, search_type="Sales", price_list=None, warehouse=None):
	...
	rows = frappe.get_all(
		...
		fields=["item_code", "item_name", "item_print_name", "item_group",
				...
				"valuation_rate", "gst_hsn_code as hsn_sac", "safety_stock", "min_order_qty", "custom_max_stock"],
	)
	if not rows:
		return None
...
def get_all_items_detailed(search_type="Sales", price_list=None, warehouse=None):
	...
	items = frappe.get_all(
		...
		filters=filters,
		fields=["item_code", "item_name", "item_print_name", "item_group",
				"stock_uom as uom", "standard_rate as rate", "valuation_rate", "gst_hsn_code as hsn_sac", "safety_stock", "min_order_qty", "custom_max_stock"],
		limit=0,
